...
train_images = np.load("train_images8.npz")['arr_0']
train_labels = np.load("train_labels8.npz")['arr_0']
test_images = np.load("test_images8.npz")['arr_0']
test_labels = np.load("test_labels8.npz")['arr_0']
